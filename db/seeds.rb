...
Course.create!(title: 'Texte - Trouve', slug: 'trouve', video_id: "-TVZPEPNHs8", pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732891/Exceltips/Exceltips_-_Trouve_c8eeux.pdf"] , pdf_slip: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732891/Exceltips/Trouve_Fiche_gq78hn.pdf"] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585732890/Exceltips/Exceltips_-_Trouve_Exercices_cmdsiq.xlsx"] )
Course.create!(title: 'Texte - Stxt', slug: 'stxt', video_id: "w9KDYxEf1sY", pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732890/Exceltips/Exceltips_-_STXT_c40ysh.pdf"] , pdf_slip: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732891/Exceltips/STXT_Fiche_hretbd.pdf"] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585732891/Exceltips/Exceltips_-_STXT_Exercices_mtxduf.xlsx"] )
Course.create!(title: 'Texte - Nbcar', slug: 'nbcar', video_id: "RhmAnCCY8Es", pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732891/Exceltips/Exceltips_-_NBCAR_aqgjlr.pdf"], pdf_slip: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732891/Exceltips/NBCAR_Fiche_hyhrby.pdf"], excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585732891/Exceltips/Exceltips_-_NBCAR_Exercices_zyodob.xlsx"])
...
Course.create!(title: 'Business - Rechercheh', slug: 'rechercheh', video_id: "mVrm6XWitXY", pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732892/Exceltips/Exceltips_-_RECHERCHEH_rxn7bo.pdf"] , pdf_slip: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732892/Exceltips/RECHERCHEH_Fiche_jtg2oz.pdf"] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585732892/Exceltips/Exceltips_-_RechercheH_Exercices_pnsgmu.xlsx"] )
Course.create!(title: 'Business - Sierreur', slug: 'sierreur', video_id: "vCq4E9sDwjg", pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732892/Exceltips/Exceltips_-_SIERREUR_qojsmc.pdf"] , pdf_slip: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732892/Exceltips/SIERREUR_Fiche_xnemuu.pdf"] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585732892/Exceltips/Exceltips_-_SIERREUR_Exercices_bzkmip.xlsx"] )
...
Course.create!(title: 'Business - Index', slug: 'index', video_id: "NZvHGGh6-qQ", pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732892/Exceltips/Exceltips_-_INDEX_uq8x3i.pdf"] , pdf_slip: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732892/Exceltips/INDEX_Fiche_n2d7ks.pdf"] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585732892/Exceltips/Exceltips_-_Index_Exercices_ukamzo.xlsx"] )
...
Course.create!(title: 'Business - Indirect', slug: 'indirect', video_id: [""], pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585732894/Exceltips/Exceltips_-_SOMMEPROD_yspjrp.pdf"] , pdf_slip: [""] , excel_course: [""] )
Course.create!(title: 'Imbrication - Qu\'est-ce que c\'est ?', slug: 'imbrications', video_id: [""], pdf_course: ["https://res.cloudinary.com/exceltipsfr/image/upload/v1585736238/Exceltips/Imbrication_les_indispensables_jmvl7b.pdf"] , pdf_slip: [""] , excel_course: [""] )
Course.create!(title: 'Imbrication - Extraire les Nom & Prénoms d\'une adresse mail', slug: 'extraire-nom-prenom-mail', video_id: [""], pdf_course: [""] , pdf_slip: [""] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585735194/Exceltips/Extraire_les_Nom_Prenoms_d_une_adresse_mail_sxxamm.xlsx"] )
Course.create!(title: 'Imbrication - Créer une adresse mail à partir d\'un nom & prénom', slug: 'créer-adresse-mail-nom-prenom', video_id: [""], pdf_course: [""] , pdf_slip: [""] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585735194/Exceltips/Creer_une_adresse_mail_a_partir_d_un_nom_prenom_e2jdth.xlsx"] )
Course.create!(title: 'Imbrication - Incorporer une erreur dans une fonction', slug: 'erreur-formule', video_id: [""], pdf_course: [""] , pdf_slip: [""] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585735194/Exceltips/Incorporer_une_erreur_dans_une_fonction_SI_yioebf.xlsx"] )
Course.create!(title: 'Imbrication - Pallier à la recherchev', slug: 'pallier-recherchev', video_id: [""], pdf_course: [""] , pdf_slip: [""] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585735194/Exceltips/Pallier_a_la_recherchev_sq9nar.xlsx"] )
Course.create!(title: 'Imbrication - Consolider des fichiers', slug: 'consolidation-fichiers', video_id: [""], pdf_course: [""] , pdf_slip: [""] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585735194/Exceltips/Consolidation_fichier_automatique_ndokkm.xlsx"] )
Course.create!(title: 'Imbrication - Faire un top10 (ou plus) sur une base de données', slug: 'top-ten', video_id: [""], pdf_course: [""] , pdf_slip: [""] , excel_course: ["https://res.cloudinary.com/exceltipsfr/raw/upload/v1585735194/Exceltips/Top_10_Automatique_hj4gky.xlsx"] )
